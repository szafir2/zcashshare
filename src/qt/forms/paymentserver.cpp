...
const QString BITCOIN_IPC_PREFIX("zcashshare:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click zcashshare: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start zcashshare: click-to-pay handler");
    else
...
{
    // clicking on zcashshare: URLs creates FileOpen events on the Mac:
