...
uint256 hashGenesisBlock("0x0510432db33a7f07113977b62a2fa501b4d5421389eee74539176d8ecc117417");
static const unsigned int timeGenesisBlock = 1475140339;// changedxx

static CBigNum bnProofOfWorkLimit(~uint256(0)>>3);
...
const string strMessageMagic = "zcashshare Signed Message:\n";
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    CBigNum bnNew;
    int64 LimUp = nTargetTimespan /4; // 400% up
    int64 LimDown = nTargetTimespan * 4; //400% down
...
if (nActualTimespan < LimUp)
	{
			...
			nTempTimespan = nActualTimespan / 4;
			bnNew *= nTempTimespan;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x158390e616bd0c73959d922dcba17bdf84deda322b0ee6a7bf0a796c8305449b");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "Zcashshare";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 50 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("041daece91e5af5ec4535b6b6817ec87610fa401eb157ca1b97044cb86ffab53248e405b8ac6f1217a1e0548f44dd0098fc24fd4fe2f89b93f9c412d904d52153d") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1475140339;//timeGenesisBlock;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 119201963;
        block.nBirthdayA = 1069116;
        block.nBirthdayB = 1281690;


        if (fTestNet)
        {
            block.nTime    = 1475140339;
            block.nNonce   = 119201963;
        }
        ...
        block.print();
        static const uint256 hashGenesisMerkleRoot = uint256("0x95125279bd745970cca00bf1bfb6d98dcde33a4562810d0d4ab0f7a2d1e55fed");
        assert(block.hashMerkleRoot == hashGenesisMerkleRoot);
        hashGenesisBlock = uint256("0x0510432db33a7f07113977b62a2fa501b4d5421389eee74539176d8ecc117417");
...
unsigned char pchMessageStart[4] = { 0x9d, 0x8f, 0x7a, 0x6f };
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("zcashshareMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("zcashshareMiner : ProcessBlock, block not accepted");
    }
